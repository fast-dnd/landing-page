...
const Intro = () => {
  return <div className="flex flex-row relative justify-between bg-black w-full">
    ...
    <div className="absolute w-full h-full flex flex-col justify-center items-center gap-16">
      <p className="font-jibril text-[28px] leading-[48px] tracking-[0.12rem] text-center uppercase"><span className="text-tomato">CHAMPIONS</span> ARE FORGED & <span className="text-tomato">LEGENDS</span> ARE WRITTEN</p>
      <div className="flex flex-row gap-5 justify-center items-center">
        <div className="w-[134px] h-0 border border-tomato"/>
        <div className="w-[10px] h-3 rotate-45 bg-white" />
        <div className="w-[134px] h-0 border border-tomato"/>
      </div>
      <p className="max-w-[800px] font-jost text-center text-xl leading-[46px] tracking-[0.25rem] uppercase font-light"><span className="font-bold">WELCOME</span> to An <span className="font-bold">exciting experience</span> filled with unexpected, bizarre adventures that are fully curated by <span className="font-bold">AI</span> and performed by <span className="font-bold">you and your friends</span>.</p>
    </div>
  </div>;
};

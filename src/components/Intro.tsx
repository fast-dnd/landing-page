...
const Intro = () => {
  return (
    <div className="flex flex-row relative justify-between bg-black w-full">
      ...
      />
      <div
        className="absolute w-full h-full flex flex-col justify-center items-center gap-16"
        id="intro"
      >
        <p
          style={jibril.style}
        ...
        >
          <span className="text-tomato">CHAMPIONS</span> ARE FORGED &{" "}
          <span className="text-tomato">LEGENDS</span> ARE WRITTEN
        </p>
        ...
        <p className="text-sm px-8 md:px-0 max-w-[800px] text-center md:text-xl leading-[21.5px] md:leading-[46px] tracking-[2.24px] md:tracking-[0.2em] uppercase font-light">
          ...
          <span className="font-bold">exciting experience</span> filled with
          unexpected, bizarre adventures that are fully curated by{" "}
          <span className="font-bold">AI</span> and performed by{" "}
          <span className="font-bold">you and your friends</span>.
        </p>
      </div>
    </div>
  );
